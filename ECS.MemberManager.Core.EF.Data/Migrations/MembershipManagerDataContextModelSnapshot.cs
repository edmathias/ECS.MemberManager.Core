...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECS.MemberManager.Core.EF.Domain.CategoryOfPerson", b =>
            {
                b.Property<int>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("int")
            ...
            modelBuilder.Entity("ECS.MemberManager.Core.EF.Domain.TermInOffice", b =>
            {
                b.Property<int>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("int")
            ...
            modelBuilder.Entity("ECS.MemberManager.Core.EF.Domain.ContactForSponsor", b =>
            {
                b.HasOne("ECS.MemberManager.Core.EF.Domain.Person", "Person")
                    .WithMany()
            ...
            modelBuilder.Entity("ECS.MemberManager.Core.EF.Domain.TermInOffice", b =>
            {
                b.HasOne("ECS.MemberManager.Core.EF.Domain.Office", "Office")
                    .WithMany()
            ...
            modelBuilder.Entity("ECS.MemberManager.Core.EF.Domain.CategoryOfOrganization",
                b => { b.Navigation("Organizations"); });

            modelBuilder.Entity("ECS.MemberManager.Core.EF.Domain.EMail", b => { b.Navigation("Persons"); });
