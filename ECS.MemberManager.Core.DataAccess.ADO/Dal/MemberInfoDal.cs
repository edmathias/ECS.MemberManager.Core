...
namespace ECS.MemberManager.Core.DataAccess.ADO
{
    public class MemberInfoDal : IMemberInfoDal
    {
        ...
        public async Task<List<MemberInfo>> Fetch()
        {
            ...
            var result = await _db.QueryAsync<MemberInfo,Person,PrivacyLevel,MemberStatus,MembershipType,MemberInfo>(sql,
        ...
        {
            var sql = "INSERT INTO [dbo].[MemberInfo] ([PersonId], [MemberNumber], [DateFirstJoined], [PrivacyLevelId], [MemberStatusId], [MembershipTypeId], [LastUpdatedBy], [LastUpdatedDate], [Notes]) "+
