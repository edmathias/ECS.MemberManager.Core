...
namespace ECS.MemberManager.Core.BusinessObjects
{
    ...
    public class ContactForSponsorEdit : BusinessBase<ContactForSponsorEdit>
    {
        ...
        public static readonly PropertyInfo<int> ContactForSponsorTypeIdProperty = RegisterProperty<int>(p => p.ContactForSponsorTypeId);
        public int ContactForSponsorTypeId
        {
            get => GetProperty(ContactForSponsorTypeIdProperty);
            set => SetProperty(ContactForSponsorTypeIdProperty, value);
        }
