...
namespace ECS.MemberManager.Core.BusinessObjects
{
    ...
    public partial class PaymentER : BusinessBase<PaymentER>
    {
        ...
        public static readonly PropertyInfo<PaymentSourceEC> PaymentSourceProperty =
            RegisterProperty<PaymentSourceEC>(o => o.PaymentSource);
        ...
        public static readonly PropertyInfo<PaymentTypeEC> PaymentTypeProperty =
            RegisterProperty<PaymentTypeEC>(o => o.PaymentType);
        ...
        private async Task Fetch(int id, [Inject] IPaymentDal dal)
        {
            ...
            using (BypassPropertyChecks)
            {
                ...
                PaymentSource = (data.PaymentSource != null
                    ? await PaymentSourceEC.GetPaymentSourceEC(data.PaymentSource)
                    : null);
                PaymentType = (data.PaymentType != null
                    ? await PaymentTypeEC.GetPaymentTypeEC(data.PaymentType)
                    : null);
