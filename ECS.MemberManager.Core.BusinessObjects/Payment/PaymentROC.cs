...
{
    [Serializable]
    public partial class PaymentROC : ReadOnlyBase<PaymentROC>
    {
        ...
        public static readonly PropertyInfo<SmartDate> PaymentDateProperty =
            RegisterProperty<SmartDate>(o => o.PaymentDate);
        ...
        public static readonly PropertyInfo<SmartDate> PaymentExpirationDateProperty =
            RegisterProperty<SmartDate>(o => o.PaymentExpirationDate);
        ...
        public static readonly PropertyInfo<PaymentSourceROC> PaymentSourceProperty =
            RegisterProperty<PaymentSourceROC>(o => o.PaymentSource);
        ...
        public static readonly PropertyInfo<PaymentTypeROC> PaymentTypeProperty =
            RegisterProperty<PaymentTypeROC>(o => o.PaymentType);
        ...
        internal static async Task<PaymentROC> GetPaymentROC(Payment childData)
        {
            return await DataPortal.FetchChildAsync<PaymentROC>(childData);
        }
        ...
        private async Task Fetch(Payment data)
        {
            ...
            PaymentSource = (data.PaymentSource != null
                ? await PaymentSourceROC.GetPaymentSourceROC(data.PaymentSource)
                : null);
