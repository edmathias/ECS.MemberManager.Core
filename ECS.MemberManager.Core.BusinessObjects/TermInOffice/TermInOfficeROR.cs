...
{
    [Serializable]
    public partial class TermInOfficeROR : BusinessBase<TermInOfficeROR>
    {
        ...
        public static async Task<TermInOfficeROR> GetTermInOfficeROR(int id)
        {
            return await DataPortal.FetchAsync<TermInOfficeROR>(id);
        }  
