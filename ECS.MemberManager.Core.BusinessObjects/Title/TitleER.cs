...
namespace ECS.MemberManager.Core.BusinessObjects
{
    ...
    public partial class TitleER : BusinessBase<TitleER>
    {
        ...
        [Fetch]
        private async Task Fetch(int id, [Inject] IDal<Title> dal)
        {
        ...
        [Insert]
        private async Task Insert([Inject] IDal<Title> dal)
        {
       ...
       [Update]
        private async Task Update([Inject] IDal<Title> dal)
        {
            FieldManager.UpdateChildren();
        ...
        [DeleteSelf]
        private async Task DeleteSelf([Inject] IDal<Title> dal)
        {
            await Delete(Id,dal);
        }
       
        [Delete]
        private async Task Delete(int id, [Inject] IDal<Title> dal)
        {
            await dal.Delete(id);
        }
