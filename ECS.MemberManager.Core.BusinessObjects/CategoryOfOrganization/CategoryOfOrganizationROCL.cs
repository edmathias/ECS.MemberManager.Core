...
namespace ECS.MemberManager.Core.BusinessObjects
{
    ...
    public partial class
        CategoryOfOrganizationROCL : ReadOnlyListBase<CategoryOfOrganizationROCL, CategoryOfOrganizationROC>
    {
        #region Factory Methods

        internal static async Task<CategoryOfOrganizationROCL> GetCategoryOfOrganizationROCL(
