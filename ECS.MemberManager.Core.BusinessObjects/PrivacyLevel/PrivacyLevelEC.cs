...
{
    [Serializable]
    public class PrivacyLevelEC : BusinessBase<PrivacyLevelEC>
    {
        ...
        internal static async Task<PrivacyLevelEC> GetPrivacyLevelEC(PrivacyLevel data)
        {
            return await DataPortal.FetchChildAsync<PrivacyLevelEC>(data);
        }
        ...
        [FetchChild]
        private void FetchChild(PrivacyLevel childData)
        {
        ...
        private async Task UpdateChild()
        {
            ...
            var privacyLevelToUpdate = new PrivacyLevel()
            {
                Id = Id,
                Description = Description,
                Notes = Notes,
            ...
            var updatedStatus = await dal.Update(privacyLevelToUpdate);
