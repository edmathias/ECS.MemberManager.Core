...
{
    [Serializable]
    public class PhoneInfo : ReadOnlyBase<PhoneInfo>
    {
        ...
        public static async Task<PhoneInfo> GetPhoneInfo(int id)
        {
            return await DataPortal.FetchAsync<PhoneInfo>(id);
        }

        public static async Task<PhoneInfo> GetPhoneInfo(Phone childData)
        {
            return await DataPortal.FetchAsync<PhoneInfo>(childData);
        }
