...
//
// Generated on 03/23/2021 09:57:24
//******************************************************************************    
...
namespace ECS.MemberManager.Core.BusinessObjects
{
    ...
    public partial class OrganizationROR : BusinessBase<OrganizationROR>
    {
        ...
        public static readonly PropertyInfo<OrganizationTypeROC> OrganizationTypeProperty =
            RegisterProperty<OrganizationTypeROC>(o => o.OrganizationType);
        ...
        private async Task Fetch(int id, [Inject] IOrganizationDal dal)
        {
            ...
            OrganizationType = (data.OrganizationType != null
                ? await OrganizationTypeROC.GetOrganizationTypeROC(data.OrganizationType)
                : null);
