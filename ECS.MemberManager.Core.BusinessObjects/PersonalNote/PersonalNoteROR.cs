...
//
// Generated on 04/14/2021 08:41:37
//******************************************************************************    
...
{
    [Serializable]
    public partial class PersonalNoteROR : BusinessBase<PersonalNoteROR>
    {
        ...
        public static async Task<PersonalNoteROR> GetPersonalNoteROR(int id)
        {
            return await DataPortal.FetchAsync<PersonalNoteROR>(id);
        }  
