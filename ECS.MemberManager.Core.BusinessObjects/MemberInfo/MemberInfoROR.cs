...
{
    [Serializable]
    public partial class MemberInfoROR : ReadOnlyBase<MemberInfoROR>
    {
        ...
        private async Task Fetch(int id)
        {
            ...
            Id = data.Id;
            Person = (data.Person != null ? await PersonROC.GetPersonROC( new Person() { Id = data.Person.Id }) : null);
            MemberNumber = data.MemberNumber;
            DateFirstJoined = data.DateFirstJoined;
            PrivacyLevel = (data.PrivacyLevel != null ? await PrivacyLevelROC.GetPrivacyLevelROC( new PrivacyLevel() { Id = data.PrivacyLevel.Id }) : null);
            MemberStatus = (data.MemberStatus != null ? await MemberStatusROC.GetMemberStatusROC( new MemberStatus() { Id = data.MemberStatus.Id }) : null);
            MembershipType = (data.MembershipType != null ? await MembershipTypeROC.GetMembershipTypeROC( new MembershipType() { Id = data.MembershipType.Id }) : null);
