...
//
// Generated on 03/23/2021 09:57:12
//******************************************************************************    
...
namespace ECS.MemberManager.Core.BusinessObjects
{
    ...
    public partial class MemberInfoER : BusinessBase<MemberInfoER>
    {
        ...
        public static readonly PropertyInfo<PrivacyLevelEC> PrivacyLevelProperty =
            RegisterProperty<PrivacyLevelEC>(o => o.PrivacyLevel);
        ...
        public static readonly PropertyInfo<MemberStatusEC> MemberStatusProperty =
            RegisterProperty<MemberStatusEC>(o => o.MemberStatus);
        ...
        public static readonly PropertyInfo<MembershipTypeEC> MembershipTypeProperty =
            RegisterProperty<MembershipTypeEC>(o => o.MembershipType);
        ...
        private async Task Fetch(int id, [Inject] IMemberInfoDal dal)
        {
            ...
            using (BypassPropertyChecks)
            {
                ...
                PrivacyLevel = (data.PrivacyLevel != null
                    ? await PrivacyLevelEC.GetPrivacyLevelEC(data.PrivacyLevel)
                    : null);
                MemberStatus = (data.MemberStatus != null
                    ? await MemberStatusEC.GetMemberStatusEC(data.MemberStatus)
                    : null);
                MembershipType = (data.MembershipType != null
                    ? await MembershipTypeEC.GetMembershipTypeEC(data.MembershipType)
                    : null);
