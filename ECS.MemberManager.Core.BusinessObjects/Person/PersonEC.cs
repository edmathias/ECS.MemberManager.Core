...
//
// Generated on 04/01/2021 14:01:32
//******************************************************************************    
...
namespace ECS.MemberManager.Core.BusinessObjects
{
    ...
    public partial class PersonEC : BusinessBase<PersonEC>
    {
        ...
        internal static async Task<PersonEC> NewPersonEC()
        {
            return await DataPortal.CreateChildAsync<PersonEC>();
        }

        internal static async Task<PersonEC> GetPersonEC(Person childData)
        {
        ...
        [InsertChild]
        private async Task Insert([Inject] IDal<Person> dal)
        {
       ...
       [UpdateChild]
        private async Task Update([Inject] IDal<Person> dal)
        {
            FieldManager.UpdateChildren();
        ...
        [DeleteSelfChild]
        private async Task DeleteSelf([Inject] IDal<Person> dal)
        {
            await Delete(Id,dal);
        }
       
        [Delete]
        private async Task Delete(int id, [Inject] IDal<Person> dal)
        {
            await dal.Delete(id);
        }
